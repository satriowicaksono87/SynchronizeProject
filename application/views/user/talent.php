			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-md-8">
							  <a href="<?= base_url('index.php/user/talent') ?>" class="btn btn-lg btn-danger">ALL</a>
								<a href="<?= base_url('index.php/user/talent/show_malang') ?>" class="btn btn-lg btn-danger ml-3">MALANG</a>
								<a href="<?= base_url('index.php/user/talent/show_jember') ?>" class="btn btn-lg btn-danger ml-3">JEMBER</a>
				</div>
				</div>
			</div>
		</section>
				...
				<div class="row">
					<?php foreach ($dj as $d): ?>
						...
						<div class="guest">
							...
							<div class="details">
								<h3><a href="<?= base_url('index.php/user/talent_detail/show/'); ?><?= $d->id_dj; ?>"><?= $d->nama_dj; ?></a></h3>
